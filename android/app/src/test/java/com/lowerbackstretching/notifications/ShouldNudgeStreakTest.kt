...
class ShouldNudgeStreakTest {
    ...
    @Test
    fun returns_false_when_user_has_opted_out() =
        runTest {
    ...
    @Test
    fun returns_false_when_user_already_stretched_today() =
        runTest {
    ...
    @Test
    fun returns_false_when_streak_is_below_threshold() =
        runTest {
            val result = shouldNudgeStreak(
                enabled = true,
                lastSessionEpochDay = todayEpochDay - 1,
    ...
    @Test
    fun returns_true_when_streak_at_risk_and_user_opted_in() =
        runTest {
            val result = shouldNudgeStreak(
                enabled = true,
                lastSessionEpochDay = todayEpochDay - 1,
    ...
    @Test
    fun returns_true_for_long_streak() =
        runTest {
            val result = shouldNudgeStreak(
                enabled = true,
                lastSessionEpochDay = todayEpochDay - 1,
    ...
    @Test
    fun never_stretched_with_zero_default_returns_false() =
        runTest {
