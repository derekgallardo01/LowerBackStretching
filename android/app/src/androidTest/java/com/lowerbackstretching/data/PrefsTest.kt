...
class PrefsTest {
    ...
    @Test
    fun defaults_when_nothing_has_been_written() =
        runBlocking {
    ...
    @Test
    fun setReminder_persists_all_three_values() =
        runBlocking {
    ...
    @Test
    fun setReminder_overwrites_previous_values() =
        runBlocking {
            prefs.setReminder(enabled = true, hour = 7, minute = 30)
    ...
    @Test
    fun markOnboardingDone_flips_the_flag() =
        runBlocking {
            assertThat(prefs.onboardingDone.first()).isFalse()
    ...
    @Test
    fun inProgress_round_trip_and_clear() =
        runBlocking {
    ...
    @Test
    fun saveInProgress_overwrites_previous_record() =
        runBlocking {
    ...
    @Test
    fun audio_defaults_when_nothing_written() =
        runBlocking {
    ...
    @Test
    fun audio_track_and_volume_round_trip() =
        runBlocking {
    ...
    @Test
    fun audio_volume_clamps_to_unit_range() =
        runBlocking {
    ...
    @Test
    fun last_session_epoch_day_defaults_to_zero() =
        runBlocking {
            assertThat(prefs.lastSessionEpochDay.first()).isEqualTo(0L)
        }

    @Test
    fun last_session_epoch_day_round_trip() =
        runBlocking {
